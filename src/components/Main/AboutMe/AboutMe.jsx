      ...
      <div className="aboutme__container">
        ...
        <div className="aboutme__info">
          ...
          <p className="aboutme__biography">Привет! Меня зовут Барик, я&nbsp;родился в&nbsp;городе Ижевск
            в&nbsp;2019&nbsp;году. Я&nbsp;домашний питомец этого замечательного человека, который разрабатывал этот
            сайт. Меня очень любят. Кушаю я&nbsp;исключительно Royal Canin. Совсем недавних пор я&nbsp;начал кодить,
